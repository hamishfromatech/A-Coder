...
<head>
	...
	<title>${escapeHtml(data.title)} - A-Coder IDE Lesson</title>
...
<body class="min-h-screen bg-void-bg-1">
	...
	<footer class="mt-16 border-t border-void-border-1 py-8">
		<div class="max-w-7xl mx-auto px-6 text-center">
			<p class="text-sm text-gray-500">Generated by A-Coder IDE • ${new Date().toLocaleDateString()}</p>
		</div>
	</footer>
...
<head>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<title>${escapeHtml(course.title)} - A-Coder IDE Course</title>
